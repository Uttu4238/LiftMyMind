...
export default function RippleButton({ children, ...props }: RippleButtonProps) {
  ...
  return (
    <button
      ref={buttonRef}
      className="font-jost duration-[600ms] relative flex items-center justify-center overflow-hidden rounded-full bg-[#cbfe7e] p-[1.3rem] text-[1.2rem] font-medium text-[#0e352e] transition hover:text-white hover:bg-[#D0E3DD]  hover:scale-105"
      onMouseEnter={(e) => {
